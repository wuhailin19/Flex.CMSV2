...
{
    /// <inheritdoc />
    public partial class AddTableContentmodel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLoginIP = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CurrentLoginTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColumnImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModelId = table.Column<int>(type: "int", nullable: true),
                    ExtensionModelId = table.Column<int>(type: "int", nullable: true),
                    ParentId = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    IsShow = table.Column<bool>(type: "bit", nullable: false),
                    ColumnUrl = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Descriptiton = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TableName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    FormHtmlString = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AddUserName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    AddUser = table.Column<long>(type: "bigint", nullable: true),
                    AddTime = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    LastEditUserName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1560206066204151804L, "webmaster", new DateTime(2023, 12, 29, 11, 28, 36, 395, DateTimeKind.Local).AddTicks(5106), 1560206066204151804L, "webmaster", true, "127.0.0.1", new DateTime(2023, 12, 29, 11, 28, 36, 395, DateTimeKind.Local).AddTicks(5106), null, null, 1560206066204151804L, "webmaster", null, null, "7675038.28325281", "5A72A8F355E9A88D03C30778C2770E27", 0, "超级管理员", "4ad9879fb285407f", null, "超级管理员", null, 0 });
