...
namespace Flex.Core.Helper
{
    ...
    public static class EncryptHelper
    {
        ...
        /// <summary> 为 RSA 非对称加密生成密钥对，并存储到文件，公钥私钥都生成C#【XML】格式</summary>
        /// <summary> 公钥私钥都生成C#【XML】格式 </summary>
        public static void CreateCSharpKeyFileForAsymmetricAlgorithm(string publicFileName, string privateFileName)
        {
        ...
        /// <summary> 为 RSA 非对称加密生成密钥对，并存储到文件，公钥生成Java【pem】格式，私钥生成C#【XML】格式</summary>
        /// <summary> 公钥生成Java【pem】格式，私钥生成C#【XML】格式 </summary>
        public static void CreateJavaKeyFileForAsymmetricAlgorithm(string publicFileName, string privateFileName)
        {
            if (string.IsNullOrEmpty(publicFileName)) throw new ArgumentNullException("publicFileName");
            ...
            using (var rsa = new RSACryptoServiceProvider())
            {
                File.WriteAllText(publicFileName, RSAPublicKeyDotNet2Java(rsa.ToXmlString(false)));
                File.WriteAllText(privateFileName, rsa.ToXmlString(true));
            }
        }
        /// <summary>    
        ...
        public static string MD5Encoding(string rawPass, object salt)
        {
            ...
            return MD5(rawPass + "{" + salt.ToString() + "}");
        }
        /// <summary>
        /// MD5加密
        /// </summary>
