...
(function () {
    ...
    */
    ...
    URL ="/System/htmlEditor/_ueditor/";
    /**
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'insertserverimages', 'insertserverfile','insertservervideo', 'emotion', 'insertvideo', 'music', 'map', 'gmap', 'insertframe', 'highlightcode', 'pagebreak', 'template', 'background', '|',
        ...
        , labelMap: {
            'anchor': '', 'undo': '', 'insertserverimages': '插入服务器端图片', 'insertserverfile': '插入服务器端文件','insertservervideo':'插入服务器端视频',
        }
        //webAppKey
        ...
        , initialStyle: 'body{font-size:12px;font-family:"宋体","微软雅黑","arial";line-height:200%}'   //编辑器内部样式,可以用来改变字体等
