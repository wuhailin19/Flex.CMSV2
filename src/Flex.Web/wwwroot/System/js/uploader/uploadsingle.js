...
; function ___initUpload() {
    ...
    var extensionsf = 'gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,txt,pdf';
    // 实例化
    ...
    function showError(code) {
        switch (code) {
            ...
            case "Q_EXCEED_SIZE_LIMIT": return "文件太大，最大支持10M大小的文件";
            case "F_EXCEED_SIZE": return "文件太大，最大支持10M大小的文件";
            default: return code;
        }
    }
    uploader.onError = function (code) {
        alert('Eroor: ' + showError(code));
    };
