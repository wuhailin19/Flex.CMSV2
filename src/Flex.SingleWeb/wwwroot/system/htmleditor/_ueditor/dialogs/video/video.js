(function () {
        ...
        function addOkListener() {
            ...
            //    $G("preview").innerHTML = "";
            //};
            $('#updateinsert').on('click', function () {
                insertSingle();
            })
            $('#insertVideoFile').on('click', function () {
                insertUpload();
            })
        }
        ...
        function createPreviewVideo(url) {
            ...
            $G("preview").innerHTML = '<div class="previewMsg"><span>' + lang.urlError + '</span></div>' +
                ...
                ' src="' + conUrl + '"  controls="" preload="none" ' +
                ' width="' + 420 + '"' +
                ' height="' + 280 + '"><source src="' + conUrl + '" type="video/mp4"/>' +
                '</video>';
        }
            ...
            initUploader: function () {
                ...
                function addFile(file) {
                    ...
                    if (!file.ext || acceptExtensions.indexOf(file.ext.toLowerCase()) == -1) {
                        tips.showFail(showError('not_allow_type'));
